const CACHE="bruno-set-tools-exposure-v2.6";
const ASSETS=["./","./index.html","./style.css?v=2.6","./app.js?v=2.6","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
