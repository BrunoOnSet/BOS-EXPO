const CACHE="bruno-set-tools-exposure-v3.3";
const ASSETS=["./","./index.html","./style.css?v=3.3","./app.js?v=3.3","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
