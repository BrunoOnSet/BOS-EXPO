const CACHE = "bos-expo-v3.34";
const ASSETS=["./","./index.html","./style.css?v=3.34","./app.js?v=3.34","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
