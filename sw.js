const CACHE="bruno-set-tools-expo-v3.18";
const ASSETS=["./","./index.html","./style.css?v=3.18","./app.js?v=3.18","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
