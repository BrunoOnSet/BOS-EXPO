const CACHE = "bos-expo-v3.45";
const ASSETS=["./","./index.html","./style.css?v=3.45","./app.js?v=3.45","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
