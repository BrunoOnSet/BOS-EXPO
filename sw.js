const CACHE = "bos-expo-v3.61";
const ASSETS=["./","./index.html","./style.css?v=3.61","./app.js?v=3.61","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
