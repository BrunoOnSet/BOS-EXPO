const CACHE="bruno-set-tools-exposure-v2.5";
const ASSETS=["./","./index.html","./style.css?v=2.5","./app.js?v=2.5","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
