const CACHE = "bruno_onset_expo_v329-v3.29";
const ASSETS=["./","./index.html","./style.css?v=3.29","./app.js?v=3.29","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
