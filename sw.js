const CACHE = "bos-expo-v3.60";
const ASSETS=["./","./index.html","./style.css?v=3.60","./app.js?v=3.60","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
