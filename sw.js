const CACHE = "bos-expo-v3.59";
const ASSETS=["./","./index.html","./style.css?v=3.59","./app.js?v=3.59","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
