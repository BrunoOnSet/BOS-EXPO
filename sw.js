const CACHE = "bos-expo-v3.46";
const ASSETS=["./","./index.html","./style.css?v=3.46","./app.js?v=3.46","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
