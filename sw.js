const CACHE="bruno-set-tools-exposure-v1.2";
const ASSETS=["./","./index.html","./style.css?v=1.2","./app.js?v=1.2","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
