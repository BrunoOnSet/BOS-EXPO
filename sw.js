const CACHE = "bos-expo-v3.53";
const ASSETS=["./","./index.html","./style.css?v=3.53","./app.js?v=3.53","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
