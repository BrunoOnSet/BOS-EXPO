const CACHE = "bos-expo-v3.55";
const ASSETS=["./","./index.html","./style.css?v=3.55","./app.js?v=3.55","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
