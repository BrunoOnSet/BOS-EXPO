const CACHE = "bos-expo-v3.51";
const ASSETS=["./","./index.html","./style.css?v=3.51","./app.js?v=3.51","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
