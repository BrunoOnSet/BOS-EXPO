const CACHE="bruno-set-tools-exposure-v3.5";
const ASSETS=["./","./index.html","./style.css?v=3.5","./app.js?v=3.5","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
