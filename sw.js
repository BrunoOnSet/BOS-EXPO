const CACHE = "bos-expo-v3.35";
const ASSETS=["./","./index.html","./style.css?v=3.35","./app.js?v=3.35","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
