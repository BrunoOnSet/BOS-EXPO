const CACHE="bruno-set-tools-exposure-v3.7";
const ASSETS=["./","./index.html","./style.css?v=3.7","./app.js?v=3.7","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
