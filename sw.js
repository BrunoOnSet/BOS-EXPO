const CACHE= "bruno-onset-expo-v322-v3.22";
const ASSETS=["./","./index.html","./style.css?v=3.22","./app.js?v=3.22","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
