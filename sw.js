const CACHE = "bruno_onset_expo_v324-v3.24";
const ASSETS=["./","./index.html","./style.css?v=3.27","./app.js?v=3.27","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
