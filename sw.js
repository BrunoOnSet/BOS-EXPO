const CACHE = "bos-expo-v3.32";
const ASSETS=["./","./index.html","./style.css?v=3.32","./app.js?v=3.32","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
