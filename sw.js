const CACHE = "bos-expo-v3.42";
const ASSETS=["./","./index.html","./style.css?v=3.42","./app.js?v=3.42","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
