const CACHE="bruno-set-tools-exposure-v3.4";
const ASSETS=["./","./index.html","./style.css?v=3.4","./app.js?v=3.4","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
