const CACHE = "bruno_onset_expo_v328-v3.28";
const ASSETS=["./","./index.html","./style.css?v=3.28","./app.js?v=3.28","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
