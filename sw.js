const CACHE = "bos-expo-v3.33";
const ASSETS=["./","./index.html","./style.css?v=3.33","./app.js?v=3.33","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
