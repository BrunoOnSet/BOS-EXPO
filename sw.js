const CACHE = "bos-expo-v3.37";
const ASSETS=["./","./index.html","./style.css?v=3.37","./app.js?v=3.37","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
