const CACHE="bruno-set-tools-exposure-v3.0";
const ASSETS=["./","./index.html","./style.css?v=3.0","./app.js?v=3.0","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
