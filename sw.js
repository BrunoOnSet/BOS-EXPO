const CACHE="bruno-set-tools-exposure-v2.8";
const ASSETS=["./","./index.html","./style.css?v=2.8","./app.js?v=2.8","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
