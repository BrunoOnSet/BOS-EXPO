const CACHE = "bos-expo-v3.54";
const ASSETS=["./","./index.html","./style.css?v=3.54","./app.js?v=3.54","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
